        ...
        /*$this->widget('ext.jwplayer.Jwplayer',array(
           ...
           /* $this->widget('ext.bmvmediaplayer.BmvMediaPlayer', array(
            ...
            $this->widget('application.extensions.smp.StrobeMediaPlayback',array(
                     'src'=>'http://primus_yii2/index.php/storage/video/Those Relaxing Sounds of Waves, Tropical Beaches with Ocean Sounds, 1080p HD Video.mp4',//'/storage/video/'.$model->video, //OR
                      //optional playlist:   
                      'playlistLinks'=>array(                                       
                                                             ),
                      'width'=>'600',
