...
/**
 * This is the model class for table "{{userloganswerstraining}}".
 *
 * The followings are the available columns in table '{{userloganswerstraining}}':
 * @property integer $id
...
class Userloganswerstraining extends CActiveRecord
{
	 ...
	 * @return Userloganswerstraining the static model class
	 */
