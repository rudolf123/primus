...
/**
 * This is the model class for table "{{userloganswers}}".
 *
 * The followings are the available columns in table '{{userloganswers}}':
 * @property integer $id
 ...
 */
class Userloganswers extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Userloganswers the static model class
	 */
